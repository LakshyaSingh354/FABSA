...
public class SentimentService {
    ...
    public String analyzeSentiment(String entity) {
        String pythonApiUrl = "https://lakshyasingh354--fabsa-fastapi-app-fastapi-app.modal.run/analyze";
    ...
    public String getSentimentFromApi(String entity) {
        ...
        String pythonApiUrl = "https://lakshyasingh354--fabsa-fastapi-app-fastapi-app.modal.run/analyze?entity=" + entity;
    ...
    public String getHistSentiment(String entity, int days){
        String apiUrl = "https://lakshyasingh354--fabsa-fastapi-app-fastapi-app.modal.run/historical_sentiment?entity=" + entity + "&days=" + days;
        RestTemplate restTemplate = new RestTemplate();
